...
export function MapTooltip() {
  ...
  return (
    <div className="pointer-events-none absolute bottom-8 left-1/2 z-10 -translate-x-1/2 rounded-lg bg-white/95 px-3 py-2 text-sm shadow-lg backdrop-blur-sm dark:bg-gray-800/95 dark:text-gray-100 border border-gray-200/50 dark:border-gray-700/50">
      {hoveredCountry && (
